...
import com.ryg.dynamicload.DLBaseSubPluginActivity;
...
public class DLPluginManager
{
	 ...
	 * 
	 * @param dexPath
	 * @return 通过反射调用AssetManager中的addAssetPath方法，将apk中的资源加载到AssetManager中
	 */
	 ...
	 * 
	 * @param assetManager
	 * @return 通过AssetManager来创建一个新的Resources对象，这个对象就是我们可以使用的apk中的资源了
	 */
	...
	public int bindPluginService(final Context context, final DLIntent dlIntent, final ServiceConnection conn, final int flags)
	{
		if (mFrom == DLConstants.FROM_INTERNAL)
		{
			dlIntent.setClassName(context, dlIntent.getPluginClass());
	...
	private Class<? extends Activity> getProxyActivityClass(Class<?> clazz)
	{
		...
		if (DLBasePluginActivity.class.isAssignableFrom(clazz)||DLBaseSubPluginActivity.class.isAssignableFrom(clazz))
		{
